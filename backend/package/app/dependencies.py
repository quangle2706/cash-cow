...
#addition - for get current user and require role
import jwt
...
async def get_current_user(
    ...
    #we will be using the decode_access_token function to decode the JWT token and extract the username
    #from the payload

    #we also want to catch any exceptions that might occur during the decoding process, such as invalid
